    ...
    <nav className='fixed m-4 top-0 right-0 left-0 shadow-lg z-50 bg-white'>
        <div className='container px-4 flex justify-between items-center h-16'>
            ...
            <div className='hidden  md:flex space-x-4 text-sm font-bold items-center'>
                ...
                <Link to="/gallary" className='px-6 py-2 hover:bg-gray-600 hover:text-white'>Gallary</Link>
               ...
               <button className='py-2 px-6 border bg-gray-300 rounded'>Login </button>
        ...
        {isOpen && (
           ...
           <button className='py-2 px-6 border bg-gray-600 rounded'> Login </button>
